...
//    void set_contents(int in_length, char in_contents[100]);
...
//    return i;
//}
//void String::set_contents(int in_length, char in_contents[100])
//{
//    char in_contents_ins[100] ;
//    strcpy(in_contents_ins,in_contents);
//    cout<<in_contents<<endl;
//    in_contents_ins[in_length] = '\0';
